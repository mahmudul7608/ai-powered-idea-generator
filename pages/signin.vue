        ...
        <form @submit.prevent="handleSignUp" class="space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                required
                class="w-full px-3 py-2 text-sm bg-gray-700/50 text-white placeholder-gray-500 border border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all"
              />
            </div>
          ...
          <div class="flex items-start">
            <input
              ...
              type="checkbox"
              required
              class="w-3.5 h-3.5 mt-0.5 bg-gray-700 border-gray-600 rounded text-indigo-600 focus:ring-2 focus:ring-indigo-500"
            />
...
useHead({
  title: "Sign Up - AI Idea Generator",
  meta: [
    {
      name: "description",
      content: "Create your account to start generating amazing project ideas",
    },
  ],
});
